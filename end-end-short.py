...
target_straight_morpho = br.Cylinder(x=br.Quantity([x_shift, TARGET_LENGTH + x_shift]),
                                     diameter=GLOBAL_DIAMETER,
                                     n=GLOBAL_N/4)

target_bouton_morpho = br.Cylinder(x=br.Quantity([x_shift, TARGET_LENGTH+x_shift]),
                                   diameter=GLOBAL_DIAMETER,
                                   n=GLOBAL_N/4)
# Add a bouton
